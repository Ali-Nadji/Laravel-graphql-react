...
(function(window, $, undefined) {
    ...
    $.addcalevent.prototype = {
		...
		*/
        ...
        _outlookFormatTime: function(dateObj) {
            var newDateObj = this._adjustToUTC(dateObj, this.options.data.time.zone);
            newDateObj.setDate(newDateObj.getDate() + 1);
            return this._getDatePart(newDateObj.getFullYear(),4)+'-'+this._getDatePart(newDateObj.getMonth()+1,2)+'-'+this._getDatePart(newDateObj.getDate(),2) +'T00:00:00+01:00';
        },
        ...
        _getUrl_hotmail: function() {
            ...
            url += '&location=' + encodeURIComponent(data.location);
            url += '&startdt=' + this._outlookFormatTime(data.timeObj.start);
            url += '&enddt=' + this._outlookFormatTime(data.timeObj.start);
