...
(function ($) {
    ...
    $.fn.fileinputLocales['fr'] = {
        ...
        msgInvalidFileType: 'Type de document invalide pour "{name}". Seulement les documents de type "{types} / CSV" sont autorisés.',
        ...
        dropZoneTitle: 'Glissez et déposez le fichier CSV ici&hellip;',
