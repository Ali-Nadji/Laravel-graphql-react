...
class GridLastJmakerActif extends Component {
        constructor(props) {
            super(props);
            ...
            props.jmaker.map(function(item) {
                ...
                if(jmakerDate > date3month){
                    if(item.state === 'JMAKER_STATE_ACTIVE'){
                        lastActif.push(item)
                    }
                }
            });
            ...
            this.props.setRowData(lastActif.length)
        }
            ...
            <div style={{ backgroundColor:'#f4f8f9' }}>
                ...
                >
                    <AgGridReact
                        ...
                        overlayNoRowsTemplate={"<div><img class='img-grid' src='/_partnerV2/images/user_none_actif.svg'><p class='label-img'>"+t('no actif users')+"</p></div>"}
                        frameworkComponents= {{
...
export default GridLastJmakerActif;
