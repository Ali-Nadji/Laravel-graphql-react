 ...
 * Generated for Laravel 5.7.28 on 2019-09-04 14:52:57.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class Artisan {
        ...
        {
                        /** @var \Infrastructure\Console\Kernel $instance */
                        return $instance->handle($input, $output);
        }
        
        /**
         * Return TRUE if schedule module is active
         *
         * @return bool 
         * @static 
         */ 
        public static function hasSchedule()
        {
                        /** @var \Infrastructure\Console\Kernel $instance */
    ...
    class Response {
         ...
         * @static 
         */ 
        public static function modal($title, $body = '', $actions = array())
        {
                        return \Illuminate\Routing\ResponseFactory::modal($title, $body, $actions);
        }
    ...
    class URL {
        ...
        {
                        /** @var \FrenchFrogs\Laravel\Routing\UrlGenerator $instance */
         ...
         *
         * @param array $query
         * @return \FrenchFrogs\Laravel\Routing\UrlGenerator 
         * @static 
         */ 
        public static function withQuery($query)
        {
                        /** @var \FrenchFrogs\Laravel\Routing\UrlGenerator $instance */
                        return $instance->withQuery($query);
        }
         ...
         * @static 
         */ 
        public static function removeQuery()
        {
                        /** @var \FrenchFrogs\Laravel\Routing\UrlGenerator $instance */
                        return $instance->removeQuery();
        }
        ...
        {
            //Method inherited from \Illuminate\Routing\UrlGenerator            
                        \FrenchFrogs\Laravel\Routing\UrlGenerator::macro($name, $macro);
        }
        ...
        {
            //Method inherited from \Illuminate\Routing\UrlGenerator            
                        \FrenchFrogs\Laravel\Routing\UrlGenerator::mixin($mixin);
        }
        ...
        {
            //Method inherited from \Illuminate\Routing\UrlGenerator            
                        return \FrenchFrogs\Laravel\Routing\UrlGenerator::hasMacro($name);
        }
    ...
    class Schema {
        ...
        public static function hasTable($table)
        {
            //Method inherited from \Illuminate\Database\Schema\MySqlBuilder            
                        /** @var \FrenchFrogs\Laravel\Database\Schema\MySqlBuilder $instance */
        ...
        public static function defaultStringLength($length)
        {
            //Method inherited from \Illuminate\Database\Schema\Builder            
                        \FrenchFrogs\Laravel\Database\Schema\MySqlBuilder::defaultStringLength($length);
        }
...
namespace  { 
    ...
    class Schema extends \FrenchFrogs\Laravel\Support\Facades\Schema {}
